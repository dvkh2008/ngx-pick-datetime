...
[![npm](https://img.shields.io/npm/v/@dvkh2008/ngx-pick-datetime.svg?maxAge=2592000?style=flat-square)](https://www.npmjs.com/package/@dvkh2008/ngx-pick-datetime)
[![npm](https://img.shields.io/npm/dm/@dvkh2008/ngx-pick-datetime.svg)](https://www.npmjs.com/package/@dvkh2008/ngx-pick-datetime)
...
-------
 ...
 1. Install with [npm](https://www.npmjs.com):`npm install @dvkh2008/ngx-pick-datetime --save`
 2. Add styles.
    If you are using Angular CLI, you can add this to your styles.css: 
    ```css
    @import "~@dvkh2008/ngx-pick-datetime/assets/style/picker.min.css";
    ``` 
 ...
 3. Add __OwlDateTimeModule__ and __OwlNativeDateTimeModule__ to your __@NgModule__ like example below
    ```typescript
     ...
     import { OwlDateTimeModule, OwlNativeDateTimeModule } from '@dvkh2008/ngx-pick-datetime';
